  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 36,
        titleSpacing: 0,
        title: const Text('Decision - THRU (2T)', style: TextStyle(fontSize: 14)),
      ),
      body: Padding(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            // BOTTOM: 4Ãƒâ€”3 grid (LEFT/THRU/RIGHT + TAGS + NEXT) Ã¢â‚¬â€ maximize height
            Expanded(
              child: LayoutBuilder(
                builder: (context, bc) {
                  const spacing = 10.0;
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, j) {
                      ...
                      final selectedTag =
                          value != 'NEXT' && d.tags.split(RegExp(r'\s+')).contains(value);
