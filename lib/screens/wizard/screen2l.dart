            ...
            Expanded(
              child: GridView.builder(
                ...
                itemBuilder: (context, i) {
                  // Decision rows (cells 12..20) are text buttons, not icon keys.
                  if (i >= 12) {
                    String label = '';
                    String value = '';
                    switch (i) {
                    ...
                    return InkWell(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(width: selectedTag ? 4 : 1),
                        ),
